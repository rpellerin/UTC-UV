...
public class PreLogoParser extends Parser {
	...
	public static final String[] tokenNames = {
		"<INVALID>", "'('", "')'", "'nb = '", "'import'", "INT", "ID", "WS", "COULEUR"
	};
	public static final int
	...
	public final CommandeContext commande() throws RecognitionException {
		...
		try {
			...
			setState(21); match(INT);
			setState(22); match(INT);
			setState(24);
			_la = _input.LA(1);
			if (_la==COULEUR) {
				{
				setState(23); match(COULEUR);
				}
			}
	...
	public static final String _serializedATN =
		...
		"\7\6\2\2\23\24\7\b\2\2\24\5\3\2\2\2\25\26\7\b\2\2\26\27\7\3\2\2\27\30"+
		"\7\7\2\2\30\32\7\7\2\2\31\33\7\n\2\2\32\31\3\2\2\2\32\33\3\2\2\2\33\34"+
		"\3\2\2\2\34\37\7\4\2\2\35\36\7\5\2\2\36 \7\7\2\2\37\35\3\2\2\2\37 \3\2"+
